...
class index extends Component {
  ...
  postItem = () => {
    ...
    if (nama !== '') {
      Axios.post(
        `https://mini-project-3a.herokuapp.com/api/input-kategori/${this.props.route.params.item.id}`,
        {
          nama: nama,
        ...
        .then((responseJson) => {
          ...
          if ((api.status = 'success')) {
            ...
            this.props.navigation.replace('IndukKategori');
          } else {
  ...
  render() {
    ...
    return (
      <>
        <Header title="Update Kategori Produk" onPress={onPress} />
        <ScrollView style={styles.containerUpdateModal}>
          <View style={[styles.container]}>
            <Text style={styles.fontInputData}>Kategori Produk</Text>
            <TextInput
