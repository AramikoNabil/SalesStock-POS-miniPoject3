...
import {paper, kasir, carton, Scan, member} from '../../../assets';
          ...
          <TouchableWithoutFeedback onPress={() => navigation.navigate('Scan')}>
            <View style={styles.viewiconListSampah}>
              <View style={styles.viewiconListSampah1}>
                <Image style={styles.iconBoard1} source={Scan} />
              </View>
              <Text style={styles.fontIconHome}> Scan Item </Text>
            </View>
          </TouchableWithoutFeedback>
          <TouchableWithoutFeedback
            onPress={() => navigation.navigate('DataBarangKasir')}>
            <View style={styles.viewiconListSampah}>
              <View style={styles.viewiconListSampah1}>
                <Image style={styles.iconBoard2} source={carton} />
              </View>
              <Text style={styles.fontIconHome}> Data Item </Text>
            </View>
          </TouchableWithoutFeedback>
        </View>
        <View style={styles.marginTop20}>
          <View style={styles.flexDirectionRow}>
            <TouchableWithoutFeedback
              ...
              <View style={styles.viewiconListSampah}>
                <View style={styles.viewiconListSampah1}>
                  <Image style={styles.iconBoard3} source={member} />
                </View>
                <Text style={styles.fontIconHome}>
                  {' '}
                  Register {'\n'} Member{' '}
                </Text>
              </View>
          ...
          <View style={styles.marginTop20}>
            <View style={styles.flexDirectionRow}>
              <TouchableWithoutFeedback
                onPress={() => navigation.navigate('AbsenKasir')}>
                <View style={styles.viewiconListSampah}>
                  <View style={styles.viewiconListSampah1}>
                    <Image style={styles.iconBoard3} source={Scan} />
                  </View>
                  <Text style={styles.fontIconHome}>Absen</Text>
                </View>
              </TouchableWithoutFeedback>
            </View>
          </View>
